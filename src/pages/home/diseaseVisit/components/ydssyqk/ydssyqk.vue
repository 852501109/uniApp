	...
	<view class="content">
		<view class="card">
			<view class="ypName">
				...
				<view class="ypInput">
					<input-autocomplete class="input" :value="ydssyqk.name" v-model="ydssyqk.name" placeholder="请填写"
						highlightColor="#FF0000" :stringList="autocompleteStringList" v-on:selectItem="selectItemS">
					</input-autocomplete>
			...
			<view class="ypUse">
				<view class="ypuseitem">
					<view class="yp-l">
						...
						<view class="dwBox">
							<input type="number" v-model="ydssyqk.time" value="" /><span class="dw">次</span>
						</view>
					</view>
					<view class="yp-r">
						<view class="title">
				...
				<view class="ypuseitem">
					<view class="yp-l">
						...
						<view class="dwBox">
							<input type="number" v-model="ydssyqk.amount" value="" /><span class="dw">剂量</span>
						</view>
					</view>
					<view class="yp-r">
						<view class="title">
